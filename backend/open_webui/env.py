...
# BASE_DIR is the parent of BACKEND_DIR (heidiai-dev/)
...
if FROM_INIT_PY:
    PACKAGE_DATA = {"version": importlib.metadata.version("heidiai")}
else:
    try:
...
REDIS_KEY_PREFIX = os.environ.get("REDIS_KEY_PREFIX", "heidiai")
...
OTEL_SERVICE_NAME = os.environ.get("OTEL_SERVICE_NAME", "heidiai")
