...
Noticed something off? Have an idea? Check our [Issues tab](https://github.com/heidiai/heidiai/issues) to see if it's already been reported or suggested. If not, feel free to open a new issue. When reporting an issue, please follow our issue templates. These templates are designed to ensure that all necessary details are provided from the start, enabling us to address your concerns more efficiently.
...
> Instead, [use the security reporting functionality](https://github.com/heidiai/heidiai/security) and ensure you comply with the outlined requirements.
...
1. Open a discussion regarding your ideas [here](https://github.com/heidiai/heidiai/discussions/new/choose).
...
Help expand our documentation by submitting issues and PRs on our [Docs Repository](https://github.com/heidiai/docs).
